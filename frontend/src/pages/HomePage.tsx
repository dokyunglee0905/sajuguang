...
function getAnimalDesc(animal: string): string {
  const map: Record<string, string> = {
    ...
    호랑이: '대담하고 카리스마가 강하며 리더십이 있어요.',
    토끼: '섬세하고 감수성이 풍부하며 주변을 편안하게 만드는 능력이 있어요.',
    용: '야망이 크고 도전을 즐기며 강한 존재감을 발휘해요.',
    뱀: '직관이 날카롭고 지혜로우며 신중하게 행동해요.',
    말: '활동적이고 자유롭게 살기를 원하며 추진력이 강해요.',
    양: '온화하고 예술적 감각이 뛰어나며 배려심이 깊어요.',
    원숭이: '재치 있고 영리하며 빠른 판단력을 가졌어요.',
    닭: '꼼꼼하고 분석적이며 완벽을 추구하는 성향이 있어요.',
    개: '충직하고 정의감이 강하며 신뢰받는 사람으로 기억돼요.',
